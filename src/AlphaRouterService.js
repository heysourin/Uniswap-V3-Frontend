...
const NODE_URL_TESTNET = process.env.NODE_URL_TESTNET;

const chainId = 80001;
const web3Provider = new ethers.providers.JsonRpcProvider(NODE_URL_TESTNET);
...
export const getPrice = async (
  ...
  const percentSlippage = new Percent(slippageAmount, 100); // taking slippageAmount percentage
